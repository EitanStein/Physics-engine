...
int main(){
    PhysicsObject circle1(std::move(ShapeFactory::createCircle(5)), BodyConfig(Point(0, 10), DirVector(0, 0), DirVector(0, -10)));
    PhysicsObject circle2(std::move(ShapeFactory::createCircle(5)), BodyConfig(Point(0, -10), DirVector(0, 0), DirVector(0, 10)));
